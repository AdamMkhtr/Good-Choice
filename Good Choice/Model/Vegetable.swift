...
""",
                                    ...
                                    fibres: "3,6g",
                                    water: "84,30g",
                                    vitamines: [Value(element: Vitamine.vitamineB9, score : .A),
                                                Value(element: Vitamine.vitamineK, score : .B),
                                                Value(element: Vitamine.vitamineB5, score : .C),
                                                Value(element: Vitamine.vitamineE, score : .C),
                                                Value(element: Vitamine.vitamineB6, score : .C)],
                                    elements: [Value(element: Mineral.potassium, score : .A),
                                               Value(element: Mineral.cuivre, score : .B),
  ...
  static let champignon = ProductDetail(type: .vegetable,
    ...
    """,
                                        ...
                                        fibres: "0,90g",
                                        water: "88,40g",
                                        vitamines: [Value(element: Vitamine.vitamineB3, score : .A),
                                                    Value(element: Vitamine.vitamineB5, score : .A),
                                                    Value(element: Vitamine.vitamineB2, score : .B),
                                                    Value(element: Vitamine.vitamineB9, score : .B)],
                                        elements: [Value(element: Mineral.cuivre, score : .A),
                                                   Value(element: Mineral.potassium, score : .B),
                                                   Value(element: Mineral.phosphore, score : .B),
                                                   Value(element: Mineral.sélénium, score : .C)])
  ...
  static let courgette = ProductDetail(type: .vegetable,
   ...
   """,
                                       ...
                                       fibres: "1,7g",
                                       water: "93,10g",
                                       vitamines: [Value(element: Vitamine.vitamineB9, score : .B),
                                                   Value(element: Vitamine.vitamineC, score : .B),
                                                   Value(element: Vitamine.vitamineB6, score : .C)],
  ...
  static let concombre = ProductDetail(type: .vegetable,
   ...
   """,
                                       ...
                                       fibres: "0,90g",
                                       water: "96,30g",
                                       vitamines: [Value(element: Vitamine.vitamineC, score : .C)],
                                       elements: [Value(element: Mineral.potassium, score : .C)])
  ...
  static let petitPois = ProductDetail(type: .vegetable,
   ...
   """,
                                       ...
                                       fibres: "4,80g",
                                       water: "77,40g",
                                       vitamines: [Value(element: Vitamine.vitamineK, score : .AP),
                                                   Value(element: Vitamine.vitamineC, score : .AP),
                                                   Value(element: Vitamine.vitamineB1, score : .A),
                                                   Value(element: Vitamine.vitamineB9, score : .A),
                                                   Value(element: Vitamine.vitamineB3, score : .C)],
                                       elements: [Value(element: Mineral.manganèse, score : .B),
                                                  Value(element: Mineral.phosphore, score : .B),
                                                  Value(element: Mineral.cuivre, score : .C),
                                                  Value(element: Mineral.fer, score : .C)])
